...
Nel corso del capitolo impareremo a cifrare un messaggio tramite cifratura a flusso, a cifrare un file tramite cifratura a blocco e come utilizzare un codice di autenticazione in coppia con un algoritmo di cifratura.
