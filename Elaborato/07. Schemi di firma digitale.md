...
A questo punto ci serve un documento da firmare. Nella [cartella d'esempio](https://github.com/MickTK/Tesi/tree/main/src/7.%20Schemi%20di%20firma%20digitale) è presente un file (pdf) che rappresenta un contratto di leasing che verrà utilizzato come esempio.
...
Nell'[esempio](https://github.com/MickTK/Tesi/blob/main/src/7.%20Schemi%20di%20firma%20digitale/7.2.permissions.py) viene anche definita una piccola interfaccia di autorizzazione:
