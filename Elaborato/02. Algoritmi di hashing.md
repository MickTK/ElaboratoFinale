...
Effettuiamo un confronto sull'efficienza delle implementazioni dell'algorimo HMAC dei moduli *Crypto.Hash* e *hmac*, campionando i tempi di esecuzione dell'algoritmo con input di 100MB.
...
I risultati del test mostrano una differenza significativa tra le medie dei due campioni, osservandou un tempo medio di esecuzione dell'algoritmo del modulo *hmac* inferiore al tempo medio di esecuzione dell'algoritmo della libreria *PyCryptoDome* (circa tre decimi di secondo di differenza).
