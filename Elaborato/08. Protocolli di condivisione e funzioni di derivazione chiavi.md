...
Vedremo ora un [esempio](https://github.com/MickTK/ElaboratoFinale/blob/main/src/8.%20Protocolli%20di%20condivisione%20e%20funzioni%20di%20derivazione%20chiavi/8.1.data.py) di come cifrare dei dati sensibili utilizzando una chiave secondaria ottenuta tramite funzione di derivazione. Nell'esempio viene cifrata una stringa contenente il codice di una carta di credito.
...
Nell'[esempio](https://github.com/MickTK/ElaboratoFinale/blob/main/src/8.%20Protocolli%20di%20condivisione%20e%20funzioni%20di%20derivazione%20chiavi/8.2.shares.py) vengono scelte casualmente delle chiavi (tra quelle generate) in un numero (K) sufficiente alla ricostruzione della chiave privata:
```python
reconstruction = []
...
Nel nostro [esempio](https://github.com/MickTK/ElaboratoFinale/blob/main/src/8.%20Protocolli%20di%20condivisione%20e%20funzioni%20di%20derivazione%20chiavi/8.3.dh.py) vediamo come concordare una chiave di sessione tra due utenti (Alice e Bob). L'esempio illustra i passi compiuti dall'elaboratore di Alice.
