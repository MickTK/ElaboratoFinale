...
Effettuiamo un confronto sull'efficienza delle implementazioni dell'algorimo HMAC dei moduli *Crypto.Hash* e *hmac*, campionando i tempi di esecuzione dell'algoritmo con input di 100MB ed una chiave da 16B.
